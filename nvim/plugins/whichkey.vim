...
let g:which_key_map.l.r = [ ':QuickRun -outputter loclist -input "="' , 'User input']
let g:which_key_map.l.1 = [ ':QuickRun -outputter loclist -cmdopt "text1.txt"' , 'Run with text1.txt']
let g:which_key_map.l.2 = [ ':QuickRun -outputter loclist -cmdopt "text2.txt"' , 'Run with text2.txt']
let g:which_key_map.l.3 = [ ':QuickRun -outputter loclist -cmdopt "text3.txt"' , 'Run with text3.txt']
let g:which_key_map.l.4 = [ ':QuickRun -outputter loclist -cmdopt "text4.txt"' , 'Run with text4.txt']
...
" ------
" -- todolist
let g:which_key_map.d = {'name' : 'todolist'}
let g:which_key_map.d.l = [':CocList todolist', 'list todolist']
let g:which_key_map.d.a = [':CocCommand todolist.create', "add a task"]
let g:which_key_map.d.c = [':CocCommand todolist.clear', "clear todlist"]

let g:which_key_map.c = { 'name' : 'coc' }

let g:which_key_map.c.g = { 'name' : 'goto'}
let g:which_key_map.c.d = ['<Plug>(coc-definition)', "definition"]
